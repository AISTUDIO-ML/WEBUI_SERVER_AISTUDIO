...
// POST: Add new user
app.onPost("/apps/users/add-user").reply(config => {
...
// GET: DATA
app.onGet("/apps/users/list").reply(config => {
...
// DELETE: Deletes User
app.onDelete("/apps/users/delete").reply(config => {
...
// GET: DATA
app.onGet("/apps/users/project-list").reply(config => {
