...
// ------------------------------------------------
// GET: Return Emails
app.onGet("/apps/email/allEmails").reply(() => {
  return [200, { emails: data.emails }]
})

// ------------------------------------------------
// GET: Return Emails
app.onGet("/apps/email/emails").reply(config => {
...
// ------------------------------------------------
app.onPost("/apps/email/update-emails-label").reply(config => {
...
// ------------------------------------------------
app.onGet("/apps/email/get-email").reply(config => {
...
// POST: Update Email
// ------------------------------------------------
app.onPost("/apps/email/update-emails").reply(config => {
...
// ------------------------------------------------
app.onGet("/apps/email/paginate-email").reply(config => {
