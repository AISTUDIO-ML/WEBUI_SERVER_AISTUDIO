...
// ------------------------------------------------
app.onGet("/apps/invoice/invoices").reply(config => {
...
// ------------------------------------------------
app.onGet("apps/invoice/single-invoice").reply(config => {
...
// GET: Return Clients
// ------------------------------------------------
app.onGet("/apps/invoice/clients").reply(() => {
...
// ------------------------------------------------
app.onDelete("/apps/invoice/delete").reply(config => {
